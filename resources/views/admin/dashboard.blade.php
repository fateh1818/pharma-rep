...
<div class="row">
    ...
    <div class="col-xl-3 col-sm-6 col-12">
        <div class="card">
            <div class="card-body">
                <div class="dash-widget-header">
                    <span class="dash-widget-icon text-success border-success" style="background-color: #e8f5e9; color: #4caf50;">
                        <i class="fe fe-trending-up"></i>
                    </span>
                    <div class="dash-count">
                        <h3>{{AppSettings::get('app_currency', '$')}} {{$today_profit}}</h3>
                    </div>
                </div>
                <div class="dash-widget-info">
                    <h6 class="text-muted">Today Net Profit</h6>
                    <div class="progress progress-sm">
